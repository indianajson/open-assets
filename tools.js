let allTools = [
    ...
    {"name": "Net Battle API Documentation","tooltype":"Documentation","description":'This link provides documentation for handling the engine APIs for chips and enemies.<br><br> <button id="download-single-tool"><a href="https://protobasilisk.github.io/OpenNetBattleDocs/api/#cardaction-objects" target="_blank" style="text-decoration:none; color:#000;">Read the Docs</a></button>',"author": "protoBASILISK"},
